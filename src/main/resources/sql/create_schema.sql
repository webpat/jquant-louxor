...
(	
	...
	TICKER_ID INTEGER NOT NULL,
 	...
 	MIC_CODE VARCHAR(30),
 	PAYMENT_CURRENCY VARCHAR(30),
 	FIRST_QUOTE DATE default null,
 	LAST_QUOTE DATE default null,
 	CONSTRAINT TICKER_PK1 PRIMARY KEY(TICKER_ID)
 	);
...
(	INDEX_COMPOSITION_ID INTEGER NOT NULL,
	INDEX_TICKER_ID INTEGER NOT NULL,
	INSTRUMENT_ID INTEGER NOT NULL,
	WEIGHT DECIMAL(14,4),
	START_DATE DATE,
	END_DATE DATE,
	CONSTRAINT FK_INDEX_COMP_STOCK FOREIGN KEY (INSTRUMENT_ID) references TICKER_STOCK(INSTRUMENT_ID),
	CONSTRAINT FK_INDEX_COMP_INDEX FOREIGN KEY (INDEX_TICKER_ID) references TICKER_INDEX(TICKER_ID)
	);
